# 🛡️ CLAUDE & AI AGENT CODEX: REPOSITORY HYGIENE & ANTI-BLOAT DIRECTIVES

> **MANDATORY PRE-FLIGHT DIRECTIVE:**
> Every AI agent (Claude Code, Cursor, Codex, OpenCode) must read and strictly obey these rules BEFORE writing code, editing files, or installing dependencies in this repository.
